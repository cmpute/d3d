...
class DetectionEvaluator:
    ...
    def calc_stats(self, gt_boxes: Target3DArray, dt_boxes: Target3DArray,
                         calib: TransformSet = None): ...

    def add_stats(self, stats: DetectionEvalStats): ...
    def get_stats(self) -> DetectionEvalStats: ...

    @property
    def score_thresholds(self) -> numpy.ndarray: ...
    def gt_count(self) -> int: ...
    def dt_count(self, score: float = float('nan')) -> Dict[Enum, float]: ...
    def tp(self, score: float = float('nan')) -> Dict[Enum, float]: ...
    def fp(self, score: float = float('nan')) -> Dict[Enum, float]: ...
    def fn(self, score: float = float('nan')) -> Dict[Enum, float]: ...
...
class TrackingEvaluator(DetectionEvaluator):
    ...
    def reset(self): ...
    def add_stats(self, stats: TrackingEvalStats): ...
